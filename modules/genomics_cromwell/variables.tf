...
variable "region" {
  description = "The default region where the CloudSQL, Compute Instance and VPCs will be deployed. List - https://cloud.google.com/compute/docs/regions-zones#available. {{UIMeta group=0 order=21 }}"
  type        = string
  default     = "us-central1"
}
...
variable "set_external_ip_policy" {
  description = "If true external IP Policy will be set to allow all. {{UIMeta group=0 order=17 updatesafe }}"
  type        = bool
  default     = false
}

variable "set_vpc_peering_policy" {
  description = "If true restrict VPC peering will be set to allow all. {{UIMeta group=0 order=18 updatesafe }}"
  type        = bool
  default     = false
}

variable "set_shielded_vm_policy" {
  description = "If true shielded VM Policy will be set to disabled. {{UIMeta group=0 order=19 updatesafe }}"
  type        = bool
  default     = false
}

variable "set_trustedimage_project_policy" {
  description = "If true trusted image projects will be set to allow all. {{UIMeta group=0 order=20 updatesafe }}"
  type        = bool
  default     = false
}
...
variable "zone" {
  description = "The default zone where the CloudSQL, Compute Instance be deployed. List - https://cloud.google.com/compute/docs/regions-zones#available. {{UIMeta group=0 order=22 }}"
  type        = string
  default     = "us-central1-a"
}